...
function getDivisiFrom(data) {
  for (const key in data) {
    if (Object.hasOwnProperty.call(data, key)) { const
      ...
      switch (divisi) {
        case "Pemrograman Java": java.push(jurusan); siswa_java.push([index, namaLengkap, divisi, jurusan, alasan]); break;
        case "Website": website.push(jurusan); siswa_website.push([index, namaLengkap, divisi, jurusan, alasan]); break;
        case "Desain Grafis": grafis.push(jurusan); siswa_grafis.push([index, namaLengkap, divisi, jurusan, alasan]); break;
        case "Office": office.push(jurusan); siswa_office.push([index, namaLengkap, divisi, jurusan, alasan]); break;
        case "Jaringan": jaringan.push(jurusan); siswa_jaringan.push([index, namaLengkap, divisi, jurusan, alasan]); break;
        case "Animasi": animasi.push(jurusan); siswa_animasi.push([index, namaLengkap, divisi, jurusan, alasan]); break;
...
function viewSiswaFrom(data) {
  for (let i = 0; i < data.length; i++) {
    const siswa = data[i]; key = siswa[2];
    switch (key) {
      case "Pemrograman Java": siswa[2] = 'Java'; break;
      case "Desain Grafis": siswa[2] = 'Grafis'; break;
    }
